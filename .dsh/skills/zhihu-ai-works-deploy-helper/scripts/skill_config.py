...
# Build-time variables supplied by HostingService and intentionally not
# exported by the runtime bootstrap.
MANAGED_BUILD_ENVIRONMENT_NAMES = ("AIWORKS_EVENT_TRACKING_TICKET",)
